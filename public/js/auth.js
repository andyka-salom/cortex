  ...
  if (sidebarEl) {
    ...
    sidebarEl.innerHTML = `
      <div class="sidebar-header">
        ...
        <div class="sidebar-brand-text" style="line-height:1.2;flex:1">
      ...
      <div class="sidebar-nav">
        <div class="sidebar-group-title"><span class="link-text">Monitoring</span></div>
    ...
    if (appLayout && localStorage.getItem('sidebarCollapsed') === 'true') {
    ...
    if (toggleBtn && appLayout) {
      toggleBtn.addEventListener('click', () => {
        ...
        // Dispatch event in case terminal or resize components need to know
